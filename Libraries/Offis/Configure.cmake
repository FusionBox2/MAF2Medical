...
IF (Offis_SOURCE_PATH)
  ...
  IF (Offis_FORCE_CONFIGURE OR NOT EXISTS ${Offis_BINARY_DIR}/build.cmake)
    ...
    EXEC_PROGRAM(${CMAKE_COMMAND} "${Offis_BINARY_PATH}" ARGS "${Offis_SOURCE_PATH}" -G"${CMAKE_GENERATOR}"  -DCMAKE_GENERATOR_PLATFORM=Win32 -DLIBRARY_OUTPUT_PATH:PATH="${LIBRARY_OUTPUT_PATH}" -DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}
